...
export function SiriWave({ variant = 'wave', size = 420, renderScale = 0.75, className, style, ...props }: SiriWaveProps) {
  ...
  React.useEffect(() => {
    ...
    const fs = compile(gl.FRAGMENT_SHADER, SHADERS[variant])
